...
public class Home extends AppCompatActivity {
    ...
    String url = "https://alseidy.midpos.com/";
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle(getString(R.string.Main_page));
        ...
        if (isNetWorkAvailable()) {
            Toast.makeText(Home.this, "there is internet", Toast.LENGTH_LONG).show();
        } else {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.my_buttons, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.scan:
                startActivity(new Intent(Home.this, Out_Scan.class));
                return true;
            case R.id.home:
                startActivity(new Intent(Home.this, Start.class));
                return true;
            case R.id.backe_page:
                onBackPressed();
                return true;
            case R.id.refresh:
